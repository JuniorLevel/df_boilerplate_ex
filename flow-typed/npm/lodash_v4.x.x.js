...
declare module 'lodash' {
	...
	declare type __CurriedFunction2<A, B, R, AA: A, BB: B> = ((...r: [AA]) => CurriedFunction1<BB, R>) & ((...r: [AA, BB]) => R);
	...
	declare type __CurriedFunction4<A, B, C, D, R, AA: A, BB: B, CC: C, DD: D> = ((...r: [AA]) => CurriedFunction3<BB, CC, DD, R>) &
	...
	declare type __CurriedFunction5<A, B, C, D, E, R, AA: A, BB: B, CC: C, DD: D, EE: E> = ((...r: [AA]) => CurriedFunction4<BB, CC, DD, EE, R>) &
	...
	declare type __CurriedFunction6<A, B, C, D, E, F, R, AA: A, BB: B, CC: C, DD: D, EE: E, FF: F> = ((...r: [AA]) => CurriedFunction5<BB, CC, DD, EE, FF, R>) &
	...
	declare type OPredicate<A, O> = ((value: A, key: string, object: O) => any) | matchesIterateeShorthand | matchesPropertyIterateeShorthand | propertyIterateeShorthand;

	declare type IterateeWithResult<V, K, O, R> = ((value: V, key: K, object: O) => R) | string;

	declare type OIterateeWithResult<V, K, O, R> = ReadOnlyIndexerObject<V, K> | IterateeWithResult<V, K, O, R>;
	declare type OIteratee<O> = OIterateeWithResult<any, any, O, any>;

	declare type AFlatMapIteratee<V, O, R> = ((item: V, index: number, array: O) => $ReadOnlyArray<R> | R) | string;
	declare type OFlatMapIteratee<V, K, O, R> = IterateeWithResult<V, K, O, $ReadOnlyArray<R> | R>;

	declare type Predicate<T> = ((value: T, index: number, array: Array<T>) => any) | matchesIterateeShorthand | matchesPropertyIterateeShorthand | propertyIterateeShorthand;
	...
	declare type ReadOnlyMapIterator<T, U> = ((item: T, index: number, array: $ReadOnlyArray<T>) => U) | propertyIterateeShorthand;
	...
	declare type Lodash = {|
		...
		difference<T>(array?: ?$ReadOnlyArray<T>, ...values: $ReadOnlyArray<?$ReadOnlyArray<T>>): Array<T>,
		differenceBy<T, U>(array?: ?$ReadOnlyArray<T>, values?: ?$ReadOnlyArray<U>, iteratee?: ?ValueOnlyIteratee<T | U>): Array<T>,
		differenceWith<T, U>(array?: ?$ReadOnlyArray<T>, values?: ?$ReadOnlyArray<U>, comparator?: ?(item: T, item2: U) => boolean): Array<T>,
		...
		findIndex: (<T>(array: $ReadOnlyArray<T>, predicate?: ?Predicate<T>, fromIndex?: ?number) => number) &
			(<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number) => -1),
		...
		indexOf: (<T>(array: $ReadOnlyArray<T>, value: T, fromIndex?: number) => number) & (<T>(array: void | null, value?: ?T, fromIndex?: ?number) => -1),
		...
		intersectionBy: (<T>(a1?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, a3?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, a3?: ?$ReadOnlyArray<T>, a4?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => Array<T>),
		// Workaround until (...parameter: T, parameter2: U) works
		intersectionWith: (<T>(a1?: ?$ReadOnlyArray<T>, comparator?: ?Comparator<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, comparator?: ?Comparator<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, a3?: ?$ReadOnlyArray<T>, comparator?: ?Comparator<T>) => Array<T>) &
			(<T>(a1?: ?$ReadOnlyArray<T>, a2?: ?$ReadOnlyArray<T>, a3?: ?$ReadOnlyArray<T>, a4?: ?$ReadOnlyArray<T>, comparator?: ?Comparator<T>) => Array<T>),
		join: (<T>(array: $ReadOnlyArray<T>, separator?: ?string) => string) & (<T>(array: void | null, separator?: ?string) => ''),
		last<T>(array: ?$ReadOnlyArray<T>): T,
		lastIndexOf: (<T>(array: $ReadOnlyArray<T>, value?: ?T, fromIndex?: ?number) => number) & (<T>(array: void | null, value?: ?T, fromIndex?: ?number) => -1),
		nth: (<T>(array: $ReadOnlyArray<T>, n?: ?number) => T) & ((array: void | null, n?: ?number) => void),
		pull: (<T>(array: Array<T>, ...values?: $ReadOnlyArray<?T>) => Array<T>) & (<T: void | null>(array: T, ...values?: $ReadOnlyArray<?any>) => T),
		pullAll: (<T>(array: Array<T>, values?: ?$ReadOnlyArray<T>) => Array<T>) & (<T: void | null>(array: T, values?: ?$ReadOnlyArray<any>) => T),
		pullAllBy: (<T>(array: Array<T>, values?: ?$ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => Array<T>) &
			(<T: void | null>(array: T, values?: ?$ReadOnlyArray<any>, iteratee?: ?ValueOnlyIteratee<any>) => T),
		...
		pullAt: (<T>(array?: ?Array<T>, ...indexed?: $ReadOnlyArray<?number>) => Array<T>) & (<T>(array?: ?Array<T>, indexed?: ?$ReadOnlyArray<number>) => Array<T>),
		remove<T>(array?: ?Array<T>, predicate?: ?Predicate<T>): Array<T>,
		reverse: (<T>(array: Array<T>) => Array<T>) & (<T: void | null>(array: T) => T),
		slice<T>(array?: ?$ReadOnlyArray<T>, start?: ?number, end?: ?number): Array<T>,
		sortedIndex: (<T>(array: $ReadOnlyArray<T>, value: T) => number) & (<T>(array: void | null, value: ?T) => 0),
		sortedIndexBy: (<T>(array: $ReadOnlyArray<T>, value?: ?T, iteratee?: ?ValueOnlyIteratee<T>) => number) &
			(<T>(array: void | null, value?: ?T, iteratee?: ?ValueOnlyIteratee<T>) => 0),
		sortedIndexOf: (<T>(array: $ReadOnlyArray<T>, value: T) => number) & (<T>(array: void | null, value?: ?T) => -1),
		sortedLastIndex: (<T>(array: $ReadOnlyArray<T>, value: T) => number) & (<T>(array: void | null, value?: ?T) => 0),
		sortedLastIndexBy: (<T>(array: $ReadOnlyArray<T>, value: T, iteratee?: ValueOnlyIteratee<T>) => number) &
			(<T>(array: void | null, value?: ?T, iteratee?: ?ValueOnlyIteratee<T>) => 0),
		sortedLastIndexOf: (<T>(array: $ReadOnlyArray<T>, value: T) => number) & (<T>(array: void | null, value?: ?T) => -1),
		...
		zip: (<A, B>(a1?: ?$ReadOnlyArray<A>, a2?: ?$ReadOnlyArray<B>) => Array<[A, B]>) &
			...
			(<A, B, C, D, E>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>, a5: $ReadOnlyArray<E>) => Array<[A, B, C, D, E]>),

		zipObject: (<K, V>(props: $ReadOnlyArray<K>, values?: ?$ReadOnlyArray<V>) => { [key: K]: V, ... }) & (<K, V>(props: void | null, values?: ?$ReadOnlyArray<V>) => { ... }),
		zipObjectDeep: ((props: $ReadOnlyArray<any>, values?: ?any) => Object) & ((props: void | null, values?: ?any) => { ... }),
		...
		zipWith: (<A>(a1?: ?$ReadOnlyArray<A>) => Array<[A]>) &
			...
			(<T, A, B>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, iteratee: (A, B) => T) => Array<T>) &
			(<A, B, C>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>) => Array<[A, B, C]>) &
			(<T, A, B, C>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, iteratee: (A, B, C) => T) => Array<T>) &
			(<A, B, C, D>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>) => Array<[A, B, C, D]>) &
			(<T, A, B, C, D>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>, a3: $ReadOnlyArray<C>, a4: $ReadOnlyArray<D>, iteratee: (A, B, C, D) => T) => Array<T>),

		// Collection
		countBy: (<T>(array: $ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => { [key: string]: number, ... }) &
		...
		filter: (<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>) => Array<T>) & (<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: OPredicate<A, T>) => Array<A>),
		find: (<T>(array: $ReadOnlyArray<T>, predicate?: ?Predicate<T>, fromIndex?: ?number) => T | void) &
			(<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number) => void) &
			(<R, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>, fromIndex?: ?number) => R),
		findLast: (<T>(array: $ReadOnlyArray<T>, predicate?: ?Predicate<T>, fromIndex?: ?number) => T | void) &
			(<T>(array: void | null, predicate?: ?Predicate<T>, fromIndex?: ?number) => void) &
			(<R, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>, fromIndex?: ?number) => R),
		flatMap: (<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, U>) => Array<U>) &
			(<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, U>) => Array<U>),
		flatMapDeep: (<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, any>) => Array<U>) &
			(<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, any>) => Array<U>),
		flatMapDepth: (<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, any>, depth?: ?number) => Array<U>) &
			(<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, any>, depth?: ?number) => Array<U>),
		...
		groupBy: (<V, T>(array: $ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => { [key: V]: Array<T>, ... }) &
			...
			(<V, A, T: ReadOnlyIndexerObject<A>>(object: T, iteratee?: ValueOnlyIteratee<A>) => { [key: V]: Array<A>, ... }),
		...
		invokeMap: (<T>(array?: ?$ReadOnlyArray<T>, path?: ?((value: T) => Path) | Path, ...args?: $ReadOnlyArray<any>) => Array<any>) &
			(<A>(object: ReadOnlyIndexerObject<A>, path: ((value: any) => Path) | Path, ...args?: $ReadOnlyArray<any>) => Array<any>),
		keyBy: (<T, V>(array: $ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>) => { [key: V]: T, ... }) &
			((array: void | null, iteratee?: ?ValueOnlyIteratee<any>) => { ... }) &
			(<V, A, K, T: ReadOnlyIndexerObject<A, K>>(object: T, iteratee?: ?ValueOnlyIteratee<A>) => { [key: V]: A, ... }),
		map: (<T, U>(array?: ?$ReadOnlyArray<T>, iteratee?: ?ReadOnlyMapIterator<T, U>) => Array<U>) &
			(<V, T: ReadOnlyIndexerObject<V>, U>(object: ?T, iteratee?: OMapIterator<V, T, U>) => Array<U>) &
			((str: ?string, iteratee?: (char: string, index: number, str: string) => any) => string),
		orderBy: (<T>(array: $ReadOnlyArray<T>, iteratees?: ?$ReadOnlyArray<Iteratee<T>> | ?string, orders?: ?$ReadOnlyArray<'asc' | 'desc'> | ?string) => Array<T>) &
			(<T>(array: null | void, iteratees?: ?$ReadOnlyArray<Iteratee<T>> | ?string, orders?: ?$ReadOnlyArray<'asc' | 'desc'> | ?string) => Array<T>) &
			(<V, T: ReadOnlyIndexerObject<V>>(object: T, iteratees?: $ReadOnlyArray<OIteratee<any>> | string, orders?: $ReadOnlyArray<'asc' | 'desc'> | string) => Array<V>),
		partition: (<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>) => [Array<T>, Array<T>]) &
			(<V, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: OPredicate<A, T>) => [Array<V>, Array<V>]),
		reduce: (<T, U>(array: $ReadOnlyArray<T>, iteratee?: (accumulator: U, value: T, index: number, array: ?Array<T>) => U, accumulator?: U) => U) &
			(<T, U>(array: void | null, iteratee?: ?(accumulator: U, value: T, index: any, array: ?Array<T>) => U, accumulator?: U) => U) &
			(<A, T: ReadOnlyIndexerObject<A>, U>(object: T, iteratee?: (accumulator: U, value: any, key: string, object: T) => U, accumulator?: U) => U),
		reduceRight: (<T, U>(array: void | null, iteratee?: ?(accumulator: U, value: T, index: any, array: ?Array<T>) => U, accumulator?: U) => U) &
			(<T, U>(array: $ReadOnlyArray<T>, iteratee?: ?(accumulator: U, value: T, index: number, array: ?Array<T>) => U, accumulator?: ?U) => U) &
			(<A, T: ReadOnlyIndexerObject<A>, U>(object: T, iteratee?: ?(accumulator: U, value: any, key: string, object: T) => U, accumulator?: ?U) => U),
		reject: (<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>) => Array<T>) & (<A, T: ReadOnlyIndexerObject<A>>(object?: ?T, predicate?: ?OPredicate<A, T>) => Array<A>),
		...
		some: (<T>(array: void | null, predicate?: ?Predicate<T>) => false) &
			...
			(<A, T: ReadOnlyIndexerObject<A>>(object?: ?T, predicate?: OPredicate<A, T>) => boolean),
		sortBy: (<T>(array: ?$ReadOnlyArray<T>, ...iteratees?: $ReadOnlyArray<Iteratee<T>>) => Array<T>) &
			(<T>(array: ?$ReadOnlyArray<T>, iteratees?: $ReadOnlyArray<Iteratee<T>>) => Array<T>) &
			(<V, T: ReadOnlyIndexerObject<V>>(object: T, ...iteratees?: $ReadOnlyArray<OIteratee<T>>) => Array<V>) &
			(<V, T: ReadOnlyIndexerObject<V>>(object: T, iteratees?: $ReadOnlyArray<OIteratee<T>>) => Array<V>),
		...
		curry: Curry & ((func: Function, arity?: number) => Function),
		curryRight(func: Function, arity?: number): Function,
		debounce<F: (...$ReadOnlyArray<any>) => any>(func: F, wait?: number, options?: DebounceOptions): F & Cancelable,
		...
		overArgs: ((func?: ?Function, ...transforms?: $ReadOnlyArray<Function>) => Function) & ((func?: ?Function, transforms?: ?$ReadOnlyArray<Function>) => Function),
		...
		rearg: ((func: Function, ...indexes: $ReadOnlyArray<number>) => Function) & ((func: Function, indexes: $ReadOnlyArray<number>) => Function),
		rest(func: Function, start?: number): Function,
		spread(func: Function): Function,
		throttle<F: (...$ReadOnlyArray<any>) => any>(func: F, wait?: number, options?: ThrottleOptions): F & Cancelable,
		unary<F: (...$ReadOnlyArray<any>) => any>(func: F): F,
		wrap(value?: any, wrapper?: ?Function): Function,

		// Lang
		castArray: (() => Array<any>) & (<T: void | null | number | string | { ... }>(value: T) => Array<T>) & (<T: Array<any>>(value: T) => T),
		clone<T>(value: T): T,
		...
		conformsTo<T: ReadOnlyIndexerObject<mixed>>(source: T, predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>): boolean,
		eq(value: any, other: any): boolean,
		gt(value: any, other: any): boolean,
		gte(value: any, other: any): boolean,
		isArguments: ((value: void | null) => false) & ((value: any) => boolean),
		isArray: ((value: $ReadOnlyArray<any>) => true) & ((value: any) => false),
		isArrayBuffer: ((value: ArrayBuffer) => true) & ((value: any) => false),
		isArrayLike: ((value: $ReadOnlyArray<any> | string | { length: number, ... }) => true) & ((value: any) => false),
		isArrayLikeObject: ((value: { length: number, ... } | $ReadOnlyArray<any>) => true) & ((value: any) => false),
		isBoolean: ((value: boolean) => true) & ((value: any) => false),
		isBuffer: ((value: void | null) => false) & ((value: any) => boolean),
		isDate: ((value: Date) => true) & ((value: any) => false),
		isElement: ((value: Element) => true) & ((value: any) => false),
		isEmpty: ((value: void | null | '' | { ... } | [] | number | boolean) => true) & ((value: any) => boolean),
		...
		isError: ((value: Error) => true) & ((value: any) => false),
		isFinite: ((value: number) => boolean) & ((value: any) => false),
		isFunction(value: any): boolean,
		isInteger: ((value: number) => boolean) & ((value: any) => false),
		isLength: ((value: void | null) => false) & ((value: any) => boolean),
		isMap: ((value: Map<any, any>) => true) & ((value: any) => false),
		...
		isNaN: ((value: number) => boolean) & ((value: any) => false),
		isNative: ((value: number | string | void | null | Object) => false) & ((value: any) => boolean),
		isNil: ((value: void | null) => true) & ((value: any) => false),
		isNull: ((value: null) => true) & ((value: any) => false),
		isNumber: ((value: number) => true) & ((value: any) => false),
		isObject: (value: any) => boolean,
		isObjectLike: ((value: void | null) => false) & ((value: any) => boolean),
		isPlainObject: (value: any) => boolean,
		isRegExp: ((value: RegExp) => true) & ((value: any) => false),
		isSafeInteger: ((value: number) => boolean) & ((value: any) => false),
		isSet: ((value: Set<any>) => true) & ((value: any) => false),
		isString: ((value: string) => true) & ((value: any) => false),
		isSymbol: ((value: Symbol) => true) & ((value: any) => false),
		isTypedArray: ((value: $TypedArray) => true) & ((value: any) => false),
		isUndefined: ((value: void) => true) & ((value: any) => false),
		isWeakMap: ((value: WeakMap<any, any>) => true) & ((value: any) => false),
		isWeakSet: ((value: WeakSet<any>) => true) & ((value: any) => false),
		lt(value: any, other: any): boolean,
		lte(value: any, other: any): boolean,
		toArray(value: any): Array<any>,
		toFinite: ((value: void | null) => 0) & ((value: any) => number),
		toInteger: ((value: void | null) => 0) & ((value: any) => number),
		toLength: ((value: void | null) => 0) & ((value: any) => number),
		toNumber: ((value: void | null) => 0) & ((value: any) => number),
		toPlainObject(value: any): Object,
		toSafeInteger: ((value: void | null) => 0) & ((value: any) => number),
		toString: ((value: void | null) => '') & ((value: any) => string),
		...
		mean(array: $ReadOnlyArray<any>): number,
		...
		sum(array: $ReadOnlyArray<any>): number,
		sumBy<T>(array: $ReadOnlyArray<T>, iteratee?: Iteratee<T>): number,

		// number
		clamp: ((number?: number, lower?: ?number, upper?: ?number) => number) & ((number: ?number, lower?: ?number, upper?: ?number) => 0),
		...
		assignInWith: (() => { ... }) &
			(<T: Object, A: Object>(object: T, s1: A, customizer?: (objValue: any, srcValue: any, key: string, object: T, source: A) => any | void) => Object) &
			(<T: Object, A: Object, B: Object>(object: T, s1: A, s2: B, customizer?: (objValue: any, srcValue: any, key: string, object: T, source: A | B) => any | void) => Object) &
		...
		at: ((object?: ?Object, ...paths: $ReadOnlyArray<string>) => Array<any>) & ((object?: ?Object, paths: $ReadOnlyArray<string>) => Array<any>),
		create: ((prototype: void | null, properties: void | null) => { ... }) & (<T>(prototype: T, properties: Object) => T) & ((prototype: any, properties: void | null) => { ... }),
		...
		findKey: (<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>) => string | void) &
			(<A, T: ReadOnlyIndexerObject<A>>(object: void | null, predicate?: ?OPredicate<A, T>) => void),
		findLastKey: (<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>) => string | void) &
			(<A, T: ReadOnlyIndexerObject<A>>(object: void | null, predicate?: ?OPredicate<A, T>) => void),
		forIn: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => null),
		forInRight: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => null),
		forOwn: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => null),
		forOwnRight: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => null),
		functions(object?: ?Object): Array<string>,
		functionsIn(object?: ?Object): Array<string>,
		get(object?: ?Object | ?$ReadOnlyArray<any> | void | null, path?: ?Path, defaultValue?: any): any,
		has: ((object: Object, path: Path) => boolean) & ((object: Object, path: void | null) => false) & ((object: void | null, path?: ?Path) => false),
		hasIn: ((object: Object, path: Path) => boolean) & ((object: Object, path: void | null) => false) & ((object: void | null, path?: ?Path) => false),
		invert: ((object: Object, multiVal?: ?boolean) => Object) & ((object: void | null, multiVal?: ?boolean) => { ... }),
		invertBy: ((object: Object, iteratee?: ?Function) => Object) & ((object: void | null, iteratee?: ?Function) => { ... }),
		invoke(object?: ?Object, path?: ?Path, ...args?: $ReadOnlyArray<any>): any,
		keys: (<K>(object?: ?ReadOnlyIndexerObject<any, K>) => Array<K>) & ((object?: ?Object) => Array<string>),
		keysIn(object?: ?Object): Array<string>,
		mapKeys: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => { ... }),
		mapValues: ((object: Object, iteratee?: ?OIteratee<any>) => Object) & ((object: void | null, iteratee?: ?OIteratee<any>) => { ... }),
		merge(object?: ?Object, ...sources?: $ReadOnlyArray<?Object>): Object,
		mergeWith: (() => { ... }) &
			(<T: Object, A: Object>(object: T, customizer?: (objValue: any, srcValue: any, key: string, object: T, source: A) => any | void) => Object) &
			(<T: Object, A: Object, B: Object>(object: T, s1: A, s2: B, customizer?: (objValue: any, srcValue: any, key: string, object: T, source: A | B) => any | void) => Object) &
			(<T: Object, A: Object, B: Object, C: Object>(
				object: T,
				s1: A,
		...
		omit: ((object?: ?Object, ...props: $ReadOnlyArray<string>) => Object) & ((object?: ?Object, props: $ReadOnlyArray<string>) => Object),
		omitBy: (<A, T: ReadOnlyIndexerObject<A>>(object: $ReadOnly<T>, predicate?: ?OPredicate<A, T>) => Object) &
			(<A, T>(object: void | null, predicate?: ?OPredicate<A, T>) => { ... }),
		pick: ((object?: ?Object, ...props: $ReadOnlyArray<string>) => Object) & ((object?: ?Object, props: $ReadOnlyArray<string>) => Object),
		pickBy: (<A, T: ReadOnlyIndexerObject<A>>(object: $ReadOnly<T>, predicate?: ?OPredicate<A, T>) => Object) &
			(<A, T>(object: void | null, predicate?: ?OPredicate<A, T>) => { ... }),
		result(object?: ?Object, path?: ?Path, defaultValue?: any): any,
		set: ((object: Object, path?: ?Path, value: any) => Object) & (<T: void | null>(object: T, path?: ?Path, value?: ?any) => T),
		setWith: (<T>(object: T, path?: ?Path, value: any, customizer?: (nsValue: any, key: string, nsObject: T) => any) => Object) &
			(<T: void | null>(object: T, path?: ?Path, value?: ?any, customizer?: ?(nsValue: any, key: string, nsObject: T) => any) => T),
		toPairs(object?: ?Object | $ReadOnlyArray<any>): Array<[string, any]>,
		toPairsIn(object?: ?Object): Array<[string, any]>,
		transform: ((collection: Object | $ReadOnlyArray<any>, iteratee?: ?OIteratee<any>, accumulator?: any) => any) &
			((collection: void | null, iteratee?: ?OIteratee<any>, accumulator?: ?any) => { ... }),
		unset: ((object: void | null, path?: ?Path) => true) & ((object: Object, path?: ?Path) => boolean),
		update: ((object: Object, path: Path, updater: Function) => Object) & (<T: void | null>(object: T, path?: ?Path, updater?: ?Function) => T),
		updateWith: ((object: Object, path?: ?Path, updater?: ?Function, customizer?: ?Function) => Object) &
			(<T: void | null>(object: T, path?: ?Path, updater?: ?Function, customizer?: ?Function) => T),
		...
		// String
		camelCase: ((string: string) => string) & ((string: void | null) => ''),
		capitalize: ((string: string) => string) & ((string: void | null) => ''),
		deburr: ((string: string) => string) & ((string: void | null) => ''),
		endsWith: ((string: string, target?: string, position?: ?number) => boolean) & ((string: void | null, target?: ?string, position?: ?number) => false),
		escape: ((string: string) => string) & ((string: void | null) => ''),
		escapeRegExp: ((string: string) => string) & ((string: void | null) => ''),
		kebabCase: ((string: string) => string) & ((string: void | null) => ''),
		lowerCase: ((string: string) => string) & ((string: void | null) => ''),
		lowerFirst: ((string: string) => string) & ((string: void | null) => ''),
		pad(string?: ?string, length?: ?number, chars?: ?string): string,
		padEnd(string?: ?string, length?: ?number, chars?: ?string): string,
		padStart(string?: ?string, length?: ?number, chars?: ?string): string,
		parseInt(string: string, radix?: ?number): number,
		repeat: ((string: string, n?: ?number) => string) & ((string: void | null, n?: ?number) => ''),
		replace: ((string: string, pattern: RegExp | string, replacement: ((string: string) => string) | string) => string) &
			((string: void | null, pattern?: ?RegExp | ?string, replacement: ?((string: string) => string) | ?string) => ''),
		snakeCase: ((string: string) => string) & ((string: void | null) => ''),
		split(string?: ?string, separator?: ?RegExp | ?string, limit?: ?number): Array<string>,
		startCase: ((string: string) => string) & ((string: void | null) => ''),
		startsWith: ((string: string, target?: string, position?: number) => boolean) & ((string: void | null, target?: ?string, position?: ?number) => false),
		template(string?: ?string, options?: ?TemplateSettings): Function,
		toLower: ((string: string) => string) & ((string: void | null) => ''),
		toUpper: ((string: string) => string) & ((string: void | null) => ''),
		trim: ((string: string, chars?: string) => string) & ((string: void | null, chars?: ?string) => ''),
		trimEnd: ((string: string, chars?: ?string) => string) & ((string: void | null, chars?: ?string) => ''),
		trimStart: ((string: string, chars?: ?string) => string) & ((string: void | null, chars?: ?string) => ''),
		truncate: ((string: string, options?: TruncateOptions) => string) & ((string: void | null, options?: ?TruncateOptions) => ''),
		unescape: ((string: string) => string) & ((string: void | null) => ''),
		upperCase: ((string: string) => string) & ((string: void | null) => ''),
		upperFirst: ((string: string) => string) & ((string: void | null) => ''),
		...
		defaultTo: (<T1: void | null, T2>(value: T1, defaultValue: T2) => T2) &
			(<T1: string | boolean, T2>(value: T1, defaultValue: T2) => T1) &
			// NaN is a number instead of its own type, otherwise it would behave like null/void
			(<T1: number, T2>(value: T1, defaultValue: T2) => T1 | T2),
		flow: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		flowRight: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		...
		over: ((...iteratees: $ReadOnlyArray<Function>) => Function) & ((iteratees: $ReadOnlyArray<Function>) => Function),
		overEvery: ((...predicates: $ReadOnlyArray<Function>) => Function) & ((predicates: $ReadOnlyArray<Function>) => Function),
		overSome: ((...predicates: $ReadOnlyArray<Function>) => Function) & ((predicates: $ReadOnlyArray<Function>) => Function),
		property(path?: ?Path): Function,
		propertyOf(object?: ?Object): Function,
		range: ((start: number, end: number, step?: number) => Array<number>) & ((end: number, step?: number) => Array<number>),
		rangeRight: ((start?: ?number, end?: ?number, step?: ?number) => Array<number>) & ((end?: ?number, step?: ?number) => Array<number>),
		...
		stubString(): '',
		stubTrue(): true,
		times: ((n?: ?number, ...rest?: $ReadOnlyArray<void | null>) => Array<number>) & (<T>(n: number, iteratee: (i: number) => T) => Array<T>),
...
declare module 'lodash/fp' {
	...
	declare type OPredicate<A> = ((value: A) => any) | matchesIterateeShorthand | matchesPropertyIterateeShorthand | propertyIterateeShorthand;
	...
	declare type Predicate<T> = ((value: T) => any) | matchesIterateeShorthand | matchesPropertyIterateeShorthand | propertyIterateeShorthand;
	...
	declare type Lodash = {|
		// Array
		chunk: (<T>(size: number) => (array: $ReadOnlyArray<T>) => Array<Array<T>>) & (<T>(size: number, array: $ReadOnlyArray<T>) => Array<Array<T>>),
		compact<T, N: ?T>(array?: ?$ReadOnlyArray<N>): Array<T>,
		concat: (<T, U, A: Array<T> | T, B: Array<U> | U>(base: A) => (elements: B) => Array<T | U>) & (<T, U, A: Array<T> | T, B: Array<U> | U>(base: A, elements: B) => Array<T | U>),
		difference: (<T>(values: $ReadOnlyArray<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(values: $ReadOnlyArray<T>, array: $ReadOnlyArray<T>) => Array<T>),
		differenceBy: (<T>(
			iteratee: ValueOnlyIteratee<T>
		) => ((values: $ReadOnlyArray<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & ((values: $ReadOnlyArray<T>, array: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>) => (array: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>, array: $ReadOnlyArray<T>) => Array<T>),
		differenceWith: (<T>(
			comparator: Comparator<T>
		) => ((first: $ReadOnlyArray<T>) => (second: $ReadOnlyArray<T>) => Array<T>) & ((first: $ReadOnlyArray<T>, second: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(comparator: Comparator<T>, first: $ReadOnlyArray<T>) => (second: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(comparator: Comparator<T>, first: $ReadOnlyArray<T>, second: $ReadOnlyArray<T>) => Array<T>),
		drop: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		dropLast: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		dropRight: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		dropRightWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		dropWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		dropLastWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		fill: (<T, U>(
			start: number
		) => ((end: number) => ((value: U) => (array: Array<T>) => Array<T | U>) & ((value: U, array: Array<T>) => Array<T | U>)) &
			((end: number, value: U) => (array: Array<T>) => Array<T | U>) &
			((end: number, value: U, array: Array<T>) => Array<T | U>)) &
			(<T, U>(start: number, end: number) => ((value: U) => (array: Array<T>) => Array<T | U>) & ((value: U, array: Array<T>) => Array<T | U>)) &
			(<T, U>(start: number, end: number, value: U) => (array: Array<T>) => Array<T | U>) &
			(<T, U>(start: number, end: number, value: U, array: Array<T>) => Array<T | U>),
		findIndex: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => number) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => number),
		findIndexFrom: (<T>(predicate: Predicate<T>) => ((fromIndex: number) => (array: $ReadOnlyArray<T>) => number) & ((fromIndex: number, array: $ReadOnlyArray<T>) => number)) &
			(<T>(predicate: Predicate<T>, fromIndex: number) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(predicate: Predicate<T>, fromIndex: number, array: $ReadOnlyArray<T>) => number),
		findLastIndex: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => number) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => number),
		findLastIndexFrom: (<T>(predicate: Predicate<T>) => ((fromIndex: number) => (array: $ReadOnlyArray<T>) => number) & ((fromIndex: number, array: $ReadOnlyArray<T>) => number)) &
			(<T>(predicate: Predicate<T>, fromIndex: number) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(predicate: Predicate<T>, fromIndex: number, array: $ReadOnlyArray<T>) => number),
		// alias of _.head
		first<T>(array: $ReadOnlyArray<T>): T,
		...
		flattenDeep<T>(array: $ReadOnlyArray<any>): Array<T>,
		flattenDepth: ((depth: number) => (array: $ReadOnlyArray<any>) => Array<any>) & ((depth: number, array: $ReadOnlyArray<any>) => Array<any>),
		fromPairs<A, B>(pairs: $ReadOnlyArray<[A, B]>): {| [key: A]: B |},
		head<T>(array: $ReadOnlyArray<T>): T,
		indexOf: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		indexOfFrom: (<T>(value: T) => ((fromIndex: number) => (array: $ReadOnlyArray<T>) => number) & ((fromIndex: number, array: $ReadOnlyArray<T>) => number)) &
			(<T>(value: T, fromIndex: number) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(value: T, fromIndex: number, array: $ReadOnlyArray<T>) => number),
		initial<T>(array: $ReadOnlyArray<T>): Array<T>,
		init<T>(array: $ReadOnlyArray<T>): Array<T>,
		intersection: (<T>(a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & (<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		intersectionBy: (<T>(
			iteratee: ValueOnlyIteratee<T>
		) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		intersectionWith: (<T>(
			comparator: Comparator<T>
		) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			...
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		join: (<T>(separator: string) => (array: $ReadOnlyArray<T>) => string) & (<T>(separator: string, array: $ReadOnlyArray<T>) => string),
		last<T>(array: $ReadOnlyArray<T>): T,
		lastIndexOf: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		lastIndexOfFrom: (<T>(value: T) => ((fromIndex: number) => (array: $ReadOnlyArray<T>) => number) & ((fromIndex: number, array: $ReadOnlyArray<T>) => number)) &
			(<T>(value: T, fromIndex: number) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(value: T, fromIndex: number, array: $ReadOnlyArray<T>) => number),
		nth: (<T>(n: number) => (array: $ReadOnlyArray<T>) => T) & (<T>(n: number, array: $ReadOnlyArray<T>) => T),
		pull: (<T>(value: T) => (array: Array<T>) => Array<T>) & (<T>(value: T, array: Array<T>) => Array<T>),
		pullAll: (<T>(values: $ReadOnlyArray<T>) => (array: Array<T>) => Array<T>) & (<T>(values: $ReadOnlyArray<T>, array: Array<T>) => Array<T>),
		pullAllBy: (<T>(
			iteratee: ValueOnlyIteratee<T>
		) => ((values: $ReadOnlyArray<T>) => (array: Array<T>) => Array<T>) & ((values: $ReadOnlyArray<T>, array: Array<T>) => Array<T>)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>) => (array: Array<T>) => Array<T>) &
			(<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>, array: Array<T>) => Array<T>),
		pullAllWith: (<T>(comparator: Function) => ((values: Array<T>) => (array: Array<T>) => Array<T>) & ((values: Array<T>, array: Array<T>) => Array<T>)) &
			(<T>(comparator: Function, values: Array<T>) => (array: Array<T>) => Array<T>) &
			(<T>(comparator: Function, values: Array<T>, array: Array<T>) => Array<T>),
		pullAt: (<T>(indexed: Array<number>) => (array: Array<T>) => Array<T>) & (<T>(indexed: Array<number>, array: Array<T>) => Array<T>),
		remove: (<T>(predicate: Predicate<T>) => (array: Array<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: Array<T>) => Array<T>),
		reverse<T>(array: Array<T>): Array<T>,
		slice: (<T>(start: number) => ((end: number) => (array: $ReadOnlyArray<T>) => Array<T>) & ((end: number, array: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(start: number, end: number) => (array: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(start: number, end: number, array: $ReadOnlyArray<T>) => Array<T>),
		sortedIndex: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		sortedIndexBy: (<T>(iteratee: ValueOnlyIteratee<T>) => ((value: T) => (array: $ReadOnlyArray<T>) => number) & ((value: T, array: $ReadOnlyArray<T>) => number)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, value: T) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(iteratee: ValueOnlyIteratee<T>, value: T, array: $ReadOnlyArray<T>) => number),
		sortedIndexOf: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		sortedLastIndex: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		sortedLastIndexBy: (<T>(iteratee: ValueOnlyIteratee<T>) => ((value: T) => (array: $ReadOnlyArray<T>) => number) & ((value: T, array: $ReadOnlyArray<T>) => number)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, value: T) => (array: $ReadOnlyArray<T>) => number) &
			(<T>(iteratee: ValueOnlyIteratee<T>, value: T, array: $ReadOnlyArray<T>) => number),
		sortedLastIndexOf: (<T>(value: T) => (array: $ReadOnlyArray<T>) => number) & (<T>(value: T, array: $ReadOnlyArray<T>) => number),
		sortedUniq<T>(array: $ReadOnlyArray<T>): Array<T>,
		sortedUniqBy<T>(iteratee: ValueOnlyIteratee<T>, array: $ReadOnlyArray<T>): Array<T>,
		tail<T>(array: $ReadOnlyArray<T>): Array<T>,
		take: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		takeRight: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		takeLast: (<T>(n: number) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(n: number, array: $ReadOnlyArray<T>) => Array<T>),
		takeRightWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		takeLastWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		takeWhile: (<T>(predicate: Predicate<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(predicate: Predicate<T>, array: $ReadOnlyArray<T>) => Array<T>),
		union: (<T>(a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & (<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		unionBy: (<T>(
			iteratee: ValueOnlyIteratee<T>
		) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		unionWith: (<T>(comparator: Comparator<T>) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		uniq<T>(array: $ReadOnlyArray<T>): Array<T>,
		uniqBy: (<T>(iteratee: ValueOnlyIteratee<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(iteratee: ValueOnlyIteratee<T>, array: $ReadOnlyArray<T>) => Array<T>),
		uniqWith: (<T>(comparator: Comparator<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(comparator: Comparator<T>, array: $ReadOnlyArray<T>) => Array<T>),
		unzip<T>(array: $ReadOnlyArray<T>): Array<T>,
		unzipWith: (<T>(iteratee: Iteratee<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(iteratee: Iteratee<T>, array: $ReadOnlyArray<T>) => Array<T>),
		without: (<T>(values: $ReadOnlyArray<T>) => (array: $ReadOnlyArray<T>) => Array<T>) & (<T>(values: $ReadOnlyArray<T>, array: $ReadOnlyArray<T>) => Array<T>),
		xor: (<T>(a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & (<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		symmetricDifference: (<T>(a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & (<T>(a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		xorBy: (<T>(
			iteratee: ValueOnlyIteratee<T>
		) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
		...
		symmetricDifferenceBy: (<T>(
			...
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		xorWith: (<T>(comparator: Comparator<T>) => ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>)) &
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		symmetricDifferenceWith: (<T>(
			...
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) &
			(<T>(comparator: Comparator<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
		zip: (<A, B>(a1: $ReadOnlyArray<A>) => (a2: $ReadOnlyArray<B>) => Array<[A, B]>) & (<A, B>(a1: $ReadOnlyArray<A>, a2: $ReadOnlyArray<B>) => Array<[A, B]>),
		...
		zipObj: ((props: $ReadOnlyArray<any>) => (values: $ReadOnlyArray<any>) => Object) & ((props: $ReadOnlyArray<any>, values: $ReadOnlyArray<any>) => Object),
		zipObjectDeep: ((props: $ReadOnlyArray<any>) => (values: any) => Object) & ((props: $ReadOnlyArray<any>, values: any) => Object),
		zipWith: (<T>(iteratee: Iteratee<T>) => ((a1: NestedArray<T>) => (a2: NestedArray<T>) => Array<T>) & ((a1: NestedArray<T>, a2: NestedArray<T>) => Array<T>)) &
			(<T>(iteratee: Iteratee<T>, a1: NestedArray<T>) => (a2: NestedArray<T>) => Array<T>) &
			(<T>(iteratee: Iteratee<T>, a1: NestedArray<T>, a2: NestedArray<T>) => Array<T>),

		// Collection
		countBy: (<T>(iteratee: ValueOnlyIteratee<T>) => (collection: Collection<T>) => { [string]: number, ... }) &
			(<T>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>) => { [string]: number, ... }),
		// alias of _.forEach
		each: (<T>(iteratee: Iteratee<T> | OIteratee<T>) => (collection: Collection<T>) => Array<T>) &
			(<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>) => Array<T>),
		// alias of _.forEachRight
		...
		every: (<T>(iteratee: Iteratee<T> | OIteratee<T>) => (collection: Collection<T>) => boolean) &
			(<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>) => boolean),
		all: (<T>(iteratee: Iteratee<T> | OIteratee<T>) => (collection: Collection<T>) => boolean) & (<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>) => boolean),
		filter: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => Array<T>) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => Array<T>),
		find: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => T | void) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => T | void),
		findFrom: (<T>(
			predicate: Predicate<T> | OPredicate<T>
		) => ((fromIndex: number) => (collection: Collection<T>) => T | void) & ((fromIndex: number, collection: Collection<T>) => T | void)) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number) => (collection: Collection<T>) => T | void) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number, collection: Collection<T>) => T | void),
		...
		findLastFrom: (<T>(
			...
			(<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number) => (collection: Collection<T>) => T | void) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number, collection: Collection<T>) => T | void),
		flatMap: (<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>) => (collection: Collection<T>) => Array<U>) &
			(<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, collection: Collection<T>) => Array<U>),
		flatMapDeep: (<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>) => (collection: Collection<T>) => Array<U>) &
			(<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, collection: Collection<T>) => Array<U>),
		flatMapDepth: (<T, U>(
			iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>
		) => ((depth: number) => (collection: Collection<T>) => Array<U>) & ((depth: number, collection: Collection<T>) => Array<U>)) &
			(<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, depth: number) => (collection: Collection<T>) => Array<U>) &
			(<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, depth: number, collection: Collection<T>) => Array<U>),
		...
		forEachRight: (<T>(iteratee: Iteratee<T> | OIteratee<T>) => (collection: Collection<T>) => Array<T>) &
			(<T>(iteratee: Iteratee<T> | OIteratee<T>, collection: Collection<T>) => Array<T>),
		groupBy: (<V, T>(iteratee: ValueOnlyIteratee<T>) => (collection: Collection<T>) => { [key: V]: Array<T>, ... }) &
			(<V, T>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>) => { [key: V]: Array<T>, ... }),
		...
		includesFrom: ((value: string) => ((fromIndex: number) => (str: string) => boolean) & ((fromIndex: number, str: string) => boolean)) &
			...
			((value: string, fromIndex: number, str: string) => boolean) &
			(<T>(value: T) => ((fromIndex: number) => (collection: $ReadOnlyArray<T>) => boolean) & ((fromIndex: number, collection: $ReadOnlyArray<T>) => boolean)) &
		...
		invokeMap: (<T>(path: ((value: T) => Path) | Path) => (collection: Collection<T>) => Array<any>) &
			(<T>(path: ((value: T) => Path) | Path, collection: Collection<T>) => Array<any>),
		invokeArgsMap: (<T>(
			path: ((value: T) => Path) | Path
		) => ((collection: Collection<T>) => (args: $ReadOnlyArray<any>) => Array<any>) & ((collection: Collection<T>, args: $ReadOnlyArray<any>) => Array<any>)) &
			(<T>(path: ((value: T) => Path) | Path, collection: Collection<T>) => (args: $ReadOnlyArray<any>) => Array<any>) &
			(<T>(path: ((value: T) => Path) | Path, collection: Collection<T>, args: $ReadOnlyArray<any>) => Array<any>),
		keyBy: (<T, V>(iteratee: ValueOnlyIteratee<T>) => (collection: Collection<T>) => { [key: V]: T, ... }) &
			(<T, V>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>) => { [key: V]: T, ... }),
		indexBy: (<T, V>(iteratee: ValueOnlyIteratee<T>) => (collection: Collection<T>) => { [key: V]: T, ... }) &
			(<T, V>(iteratee: ValueOnlyIteratee<T>, collection: Collection<T>) => { [key: V]: T, ... }),
		map: (<T, U>(iteratee: MapIterator<T, U> | OMapIterator<T, U>) => (collection: Collection<T>) => Array<U>) &
			(<T, U>(iteratee: MapIterator<T, U> | OMapIterator<T, U>, collection: Collection<T>) => Array<U>) &
			((iteratee: (char: string) => any) => (str: string) => string) &
			((iteratee: (char: string) => any, str: string) => string),
		pluck: (<T, U>(iteratee: MapIterator<T, U> | OMapIterator<T, U>) => (collection: Collection<T>) => Array<U>) &
			(<T, U>(iteratee: MapIterator<T, U> | OMapIterator<T, U>, collection: Collection<T>) => Array<U>) &
			((iteratee: (char: string) => any) => (str: string) => string) &
			((iteratee: (char: string) => any, str: string) => string),
		orderBy: (<T>(
			...
			((orders: $ReadOnlyArray<'asc' | 'desc'> | string, collection: Collection<T>) => Array<T>)) &
			(<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<any>> | string, orders: $ReadOnlyArray<'asc' | 'desc'> | string) => (collection: Collection<T>) => Array<T>) &
			(<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<any>> | string, orders: $ReadOnlyArray<'asc' | 'desc'> | string, collection: Collection<T>) => Array<T>),
		partition: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => [Array<T>, Array<T>]) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => [Array<T>, Array<T>]),
		reduce: (<T, U>(iteratee: (accumulator: U, value: T) => U) => ((accumulator: U) => (collection: Collection<T>) => U) & ((accumulator: U, collection: Collection<T>) => U)) &
			(<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U) => (collection: Collection<T>) => U) &
			(<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U, collection: Collection<T>) => U),
		reduceRight: (<T, U>(
			iteratee: (value: T, accumulator: U) => U
		) => ((accumulator: U) => (collection: Collection<T>) => U) & ((accumulator: U, collection: Collection<T>) => U)) &
			(<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U) => (collection: Collection<T>) => U) &
			(<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U, collection: Collection<T>) => U),
		reject: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => Array<T>) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => Array<T>),
		sample<T>(collection: Collection<T>): T,
		sampleSize: (<T>(n: number) => (collection: Collection<T>) => Array<T>) & (<T>(n: number, collection: Collection<T>) => Array<T>),
		...
		some: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => boolean) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => boolean),
		any: (<T>(predicate: Predicate<T> | OPredicate<T>) => (collection: Collection<T>) => boolean) &
			(<T>(predicate: Predicate<T> | OPredicate<T>, collection: Collection<T>) => boolean),
		sortBy: (<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<T>> | Iteratee<T> | OIteratee<T>) => (collection: Collection<T>) => Array<T>) &
			(<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<T>> | Iteratee<T> | OIteratee<T>, collection: Collection<T>) => Array<T>),

		// Date
		now(): number,

		// Function
		after: ((fn: Function) => (n: number) => Function) & ((fn: Function, n: number) => Function),
		ary(func: Function): Function,
		nAry: ((n: number) => (func: Function) => Function) & ((n: number, func: Function) => Function),
		before: ((fn: Function) => (n: number) => Function) & ((fn: Function, n: number) => Function),
		bind: ((func: Function) => (thisArg: any) => Function) & ((func: Function, thisArg: any) => Function),
		bindKey: ((obj: Object) => (key: string) => Function) & ((obj: Object, key: string) => Function),
		curry: Curry,
		curryN: ((arity: number) => (func: Function) => Function) & ((arity: number, func: Function) => Function),
		curryRight(func: Function): Function,
		curryRightN: ((arity: number) => (func: Function) => Function) & ((arity: number, func: Function) => Function),
		debounce: ((wait: number) => <A, R>(func: (...A) => R) => (...A) => R) & (<A, R>(wait: number, func: (...A) => R) => (...A) => R),
		defer(func: (...$ReadOnlyArray<any>) => any): TimeoutID,
		delay: ((wait: number) => (func: Function) => TimeoutID) & ((wait: number, func: Function) => TimeoutID),
		...
		overArgs: ((func: Function) => (transforms: $ReadOnlyArray<Function>) => Function) & ((func: Function, transforms: $ReadOnlyArray<Function>) => Function),
		useWith: ((func: Function) => (transforms: $ReadOnlyArray<Function>) => Function) & ((func: Function, transforms: $ReadOnlyArray<Function>) => Function),
		partial: ((func: Function) => (partials: $ReadOnlyArray<any>) => Function) & ((func: Function, partials: $ReadOnlyArray<any>) => Function),
		partialRight: ((func: Function) => (partials: $ReadOnlyArray<any>) => Function) & ((func: Function, partials: $ReadOnlyArray<any>) => Function),
		rearg: ((indexes: $ReadOnlyArray<number>) => (func: Function) => Function) & ((indexes: $ReadOnlyArray<number>, func: Function) => Function),
		rest(func: Function): Function,
		unapply(func: Function): Function,
		restFrom: ((start: number) => (func: Function) => Function) & ((start: number, func: Function) => Function),
		spread(func: Function): Function,
		apply(func: Function): Function,
		spreadFrom: ((start: number) => (func: Function) => Function) & ((start: number, func: Function) => Function),
		throttle: (<A, R>(wait: number) => (func: (...A) => R) => (...A) => R) & (<A, R>(wait: number, func: (...A) => R) => (...A) => R),
		unary<T, R>(func: (T, ...$ReadOnlyArray<any>) => R): (T) => R,
		wrap: ((wrapper: Function) => (value: any) => Function) & ((wrapper: Function, value: any) => Function),
		...
		cloneDeepWith: (<T, U>(customizer: (value: T, key: number | string, object: T, stack: any) => U) => (value: T) => U) &
			(<T, U>(customizer: (value: T, key: number | string, object: T, stack: any) => U, value: T) => U),
		cloneWith: (<T, U>(customizer: (value: T, key: number | string, object: T, stack: any) => U) => (value: T) => U) &
			(<T, U>(customizer: (value: T, key: number | string, object: T, stack: any) => U, value: T) => U),
		conformsTo: (<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>) => (source: T) => boolean) &
			(<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>, source: T) => boolean),
		where: (<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>) => (source: T) => boolean) &
			(<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>, source: T) => boolean),
		conforms: (<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>) => (source: T) => boolean) &
			(<T: ReadOnlyIndexerObject<mixed>>(predicates: T & $ReadOnly<{ [key: string]: (x: any) => boolean, ... }>, source: T) => boolean),
		eq: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		identical: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		gt: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		gte: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		...
		isEqual: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		equals: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		isEqualWith: (<T, U>(
			customizer: (objValue: any, otherValue: any, key: number | string, object: T, other: U, stack: any) => boolean | void
		) => ((value: T) => (other: U) => boolean) & ((value: T, other: U) => boolean)) &
			(<T, U>(customizer: (objValue: any, otherValue: any, key: number | string, object: T, other: U, stack: any) => boolean | void, value: T) => (other: U) => boolean) &
			(<T, U>(customizer: (objValue: any, otherValue: any, key: number | string, object: T, other: U, stack: any) => boolean | void, value: T, other: U) => boolean),
		...
		isMatch: ((source: Object) => (object: Object) => boolean) & ((source: Object, object: Object) => boolean),
		whereEq: ((source: Object) => (object: Object) => boolean) & ((source: Object, object: Object) => boolean),
		isMatchWith: (<T: Object, U: Object>(
			customizer: (objValue: any, srcValue: any, key: number | string, object: T, source: U) => boolean | void
		) => ((source: U) => (object: T) => boolean) & ((source: U, object: T) => boolean)) &
			(<T: Object, U: Object>(customizer: (objValue: any, srcValue: any, key: number | string, object: T, source: U) => boolean | void, source: U) => (object: T) => boolean) &
			(<T: Object, U: Object>(customizer: (objValue: any, srcValue: any, key: number | string, object: T, source: U) => boolean | void, source: U, object: T) => boolean),
		...
		lt: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		lte: ((value: any) => (other: any) => boolean) & ((value: any, other: any) => boolean),
		toArray(value: any): Array<any>,
		...
		inRange: ((start: number) => ((end: number) => (number: number) => boolean) & ((end: number, number: number) => boolean)) &
			...
			((start: number, end: number, number: number) => boolean),
		random: ((lower: number) => (upper: number) => number) & ((lower: number, upper: number) => number),

		// Object
		assign: ((object: Object) => (source: Object) => Object) & ((object: Object, source: Object) => Object),
		assignAll(objects: Array<Object>): Object,
		assignInAll(objects: Array<Object>): Object,
		extendAll(objects: Array<Object>): Object,
		assignIn: (<A, B>(a: A) => (b: B) => A & B) & (<A, B>(a: A, b: B) => A & B),
		assignInWith: (<T: Object, A: Object>(
			...
			(<T: Object, A: Object>(customizer: (objValue: any, srcValue: any, key: string, object: T, source: A) => any | void, object: T) => (s1: A) => Object) &
			(<T: Object, A: Object>(customizer: (objValue: any, srcValue: any, key: string, object: T, source: A) => any | void, object: T, s1: A) => Object),
		...
		assignInAllWith: ((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void) => (objects: Array<Object>) => Object) &
			((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void, objects: Array<Object>) => Object),
		...
		assignAllWith: ((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void) => (objects: Array<Object>) => Object) &
			((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void, objects: Array<Object>) => Object),
		at: ((paths: $ReadOnlyArray<string>) => (object: Object) => Array<any>) & ((paths: $ReadOnlyArray<string>, object: Object) => Array<any>),
		props: ((paths: $ReadOnlyArray<string>) => (object: Object) => Array<any>) & ((paths: $ReadOnlyArray<string>, object: Object) => Array<any>),
		paths: ((paths: $ReadOnlyArray<string>) => (object: Object) => Array<any>) & ((paths: $ReadOnlyArray<string>, object: Object) => Array<any>),
		create<T>(prototype: T): T,
		defaults: ((source: Object) => (object: Object) => Object) & ((source: Object, object: Object) => Object),
		defaultsAll(objects: Array<Object>): Object,
		defaultsDeep: ((source: Object) => (object: Object) => Object) & ((source: Object, object: Object) => Object),
		...
		entriesIn(object: Object): Array<[string, any]>,
		// alias for _.assignIn
		extend: (<A, B>(a: A) => (b: B) => A & B) & (<A, B>(a: A, b: B) => A & B),
		// alias for _.assignInWith
		...
		findKey: (<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>) => (object: T) => string | void) &
			(<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>, object: T) => string | void),
		findLastKey: (<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>) => (object: T) => string | void) &
			(<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>, object: T) => string | void),
		forIn: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		forInRight: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		forOwn: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		forOwnRight: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		functions(object: Object): Array<string>,
		functionsIn(object: Object): Array<string>,
		get: ((path: Path) => (object: Object | $ReadOnlyArray<any> | void | null) => any) & ((path: Path, object: Object | $ReadOnlyArray<any> | void | null) => any),
		prop: ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any>) => any),
		path: ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any>) => any),
		getOr: ((defaultValue: any) => ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any> | void | null) => any)) &
			((defaultValue: any, path: Path) => (object: Object | $ReadOnlyArray<any> | void | null) => any) &
			((defaultValue: any, path: Path, object: Object | $ReadOnlyArray<any> | void | null) => any),
		propOr: ((defaultValue: any) => ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any>) => any)) &
			((defaultValue: any, path: Path) => (object: Object | $ReadOnlyArray<any>) => any) &
			((defaultValue: any, path: Path, object: Object | $ReadOnlyArray<any>) => any),
		pathOr: ((defaultValue: any) => ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any>) => any)) &
			((defaultValue: any, path: Path) => (object: Object | $ReadOnlyArray<any>) => any) &
			((defaultValue: any, path: Path, object: Object | $ReadOnlyArray<any>) => any),
		has: ((path: Path) => (object: Object) => boolean) & ((path: Path, object: Object) => boolean),
		hasIn: ((path: Path) => (object: Object) => boolean) & ((path: Path, object: Object) => boolean),
		invert(object: Object): Object,
		invertObj(object: Object): Object,
		invertBy: ((iteratee: Function) => (object: Object) => Object) & ((iteratee: Function, object: Object) => Object),
		invoke: ((path: Path) => (object: Object) => any) & ((path: Path, object: Object) => any),
		invokeArgs: ((path: Path) => ((object: Object) => (args: Array<any>) => any) & ((object: Object, args: Array<any>) => any)) &
			((path: Path, object: Object) => (args: Array<any>) => any) &
			((path: Path, object: Object, args: Array<any>) => any),
		keys: (<K>(object: ReadOnlyIndexerObject<any, K>) => Array<K>) & ((object: Object) => Array<string>),
		keysIn(object: Object): Array<string>,
		mapKeys: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		mapValues: ((iteratee: OIteratee<any>) => (object: Object) => Object) & ((iteratee: OIteratee<any>, object: Object) => Object),
		merge: ((object: Object) => (source: Object) => Object) & ((object: Object, source: Object) => Object),
		...
		mergeWith: (<T: Object, A: Object, B: Object>(
			...
			(<T: Object, A: Object, B: Object>(customizer: (objValue: any, srcValue: any, key: string, object: T, source: A | B) => any | void, object: T) => (s1: A) => Object) &
			(<T: Object, A: Object, B: Object>(customizer: (objValue: any, srcValue: any, key: string, object: T, source: A | B) => any | void, object: T, s1: A) => Object),
		mergeAllWith: ((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void) => (objects: $ReadOnlyArray<Object>) => Object) &
			((customizer: (objValue: any, srcValue: any, key: string, object: Object, source: Object) => any | void, objects: $ReadOnlyArray<Object>) => Object),
		omit: ((props: $ReadOnlyArray<string>) => (object: Object) => Object) & ((props: $ReadOnlyArray<string>, object: Object) => Object),
		omitAll: ((props: $ReadOnlyArray<string>) => (object: Object) => Object) & ((props: $ReadOnlyArray<string>, object: Object) => Object),
		...
		pick: ((...props: $ReadOnlyArray<string | { ... }>) => Object) &
			...
			((...props: $ReadOnlyArray<string>) => (object: Object) => Object) &
			((props: $ReadOnlyArray<string>) => (object: Object) => Object),
		pickAll: ((props: $ReadOnlyArray<string>) => (object: Object) => Object) & ((props: $ReadOnlyArray<string>, object: Object) => Object),
		pickBy: (<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>) => (object: T) => Object) &
			(<A, T: ReadOnlyIndexerObject<A>>(predicate: OPredicate<A>, object: T) => Object),
		result: ((path: Path) => (object: Object) => any) & ((path: Path, object: Object) => any),
		set: ((path: Path) => ((value: any) => (object: Object) => Object) & ((value: any, object: Object) => Object)) &
			((path: Path, value: any) => (object: Object) => Object) &
			((path: Path, value: any, object: Object) => Object),
		assoc: ((path: Path) => ((value: any) => (object: Object) => Object) & ((value: any, object: Object) => Object)) &
			((path: Path, value: any) => (object: Object) => Object) &
			((path: Path, value: any, object: Object) => Object),
		assocPath: ((path: Path) => ((value: any) => (object: Object) => Object) & ((value: any, object: Object) => Object)) &
			((path: Path, value: any) => (object: Object) => Object) &
			((path: Path, value: any, object: Object) => Object),
		setWith: (<T>(
			customizer: (nsValue: any, key: string, nsObject: T) => any
		) => ((path: Path) => ((value: any) => (object: T) => Object) & ((value: any, object: T) => Object)) &
			((path: Path, value: any) => (object: T) => Object) &
			((path: Path, value: any, object: T) => Object)) &
			(<T>(customizer: (nsValue: any, key: string, nsObject: T) => any, path: Path) => ((value: any) => (object: T) => Object) & ((value: any, object: T) => Object)) &
			(<T>(customizer: (nsValue: any, key: string, nsObject: T) => any, path: Path, value: any) => (object: T) => Object) &
			(<T>(customizer: (nsValue: any, key: string, nsObject: T) => any, path: Path, value: any, object: T) => Object),
		toPairs(object: Object | $ReadOnlyArray<any>): Array<[string, any]>,
		toPairsIn(object: Object): Array<[string, any]>,
		transform: ((
			iteratee: OIteratee<any>
		) => ((accumulator: any) => (collection: Object | $ReadOnlyArray<any>) => any) & ((accumulator: any, collection: Object | $ReadOnlyArray<any>) => any)) &
			((iteratee: OIteratee<any>, accumulator: any) => (collection: Object | $ReadOnlyArray<any>) => any) &
			((iteratee: OIteratee<any>, accumulator: any, collection: Object | $ReadOnlyArray<any>) => any),
		unset: ((path: Path) => (object: Object) => Object) & ((path: Path, object: Object) => Object),
		update: ((path: Path) => ((updater: Function) => (object: Object) => Object) & ((updater: Function, object: Object) => Object)) &
			((path: Path, updater: Function) => (object: Object) => Object) &
			((path: Path, updater: Function, object: Object) => Object),
		updateWith: ((
			customizer: Function
		) => ((path: Path) => ((updater: Function) => (object: Object) => Object) & ((updater: Function, object: Object) => Object)) &
			((path: Path, updater: Function) => (object: Object) => Object) &
			((path: Path, updater: Function, object: Object) => Object)) &
			((customizer: Function, path: Path) => ((updater: Function) => (object: Object) => Object) & ((updater: Function, object: Object) => Object)) &
			((customizer: Function, path: Path, updater: Function) => (object: Object) => Object) &
			((customizer: Function, path: Path, updater: Function, object: Object) => Object),
		values(object: Object): Array<any>,
		valuesIn(object: Object): Array<any>,

		tap: (<T>(interceptor: (value: T) => any) => (value: T) => T) & (<T>(interceptor: (value: T) => any, value: T) => T),
		thru: (<T1, T2>(interceptor: (value: T1) => T2) => (value: T1) => T2) & (<T1, T2>(interceptor: (value: T1) => T2, value: T1) => T2),

		// String
		camelCase(string: string): string,
		capitalize(string: string): string,
		deburr(string: string): string,
		endsWith: ((target: string) => (string: string) => boolean) & ((target: string, string: string) => boolean),
		escape(string: string): string,
		escapeRegExp(string: string): string,
		kebabCase(string: string): string,
		lowerCase(string: string): string,
		lowerFirst(string: string): string,
		pad: ((length: number) => (string: string) => string) & ((length: number, string: string) => string),
		padChars: ((chars: string) => ((length: number) => (string: string) => string) & ((length: number, string: string) => string)) &
			...
			((chars: string, length: number, string: string) => string),
		padEnd: ((length: number) => (string: string) => string) & ((length: number, string: string) => string),
		padCharsEnd: ((chars: string) => ((length: number) => (string: string) => string) & ((length: number, string: string) => string)) &
			((chars: string, length: number) => (string: string) => string) &
			((chars: string, length: number, string: string) => string),
		padStart: ((length: number) => (string: string) => string) & ((length: number, string: string) => string),
		padCharsStart: ((chars: string) => ((length: number) => (string: string) => string) & ((length: number, string: string) => string)) &
			((chars: string, length: number) => (string: string) => string) &
			((chars: string, length: number, string: string) => string),
		parseInt: ((radix: number) => (string: string) => number) & ((radix: number, string: string) => number),
		repeat: ((n: number) => (string: string) => string) & ((n: number, string: string) => string),
		replace: ((
			pattern: RegExp | string
		) => ((replacement: ((string: string) => string) | string) => (string: string) => string) & ((replacement: ((string: string) => string) | string, string: string) => string)) &
			((pattern: RegExp | string, replacement: ((string: string) => string) | string) => (string: string) => string) &
			((pattern: RegExp | string, replacement: ((string: string) => string) | string, string: string) => string),
		snakeCase(string: string): string,
		split: ((separator: RegExp | string) => (string: string) => Array<string>) & ((separator: RegExp | string, string: string) => Array<string>),
		startCase(string: string): string,
		startsWith: ((target: string) => (string: string) => boolean) & ((target: string, string: string) => boolean),
		template(string: string): Function,
		toLower(string: string): string,
		toUpper(string: string): string,
		trim(string: string): string,
		trimChars: ((chars: string) => (string: string) => string) & ((chars: string, string: string) => string),
		trimEnd(string: string): string,
		trimCharsEnd: ((chars: string) => (string: string) => string) & ((chars: string, string: string) => string),
		trimStart(string: string): string,
		trimCharsStart: ((chars: string) => (string: string) => string) & ((chars: string, string: string) => string),
		truncate: ((options: TruncateOptions) => (string: string) => string) & ((options: TruncateOptions, string: string) => string),
		...
		bindAll: ((methodNames: $ReadOnlyArray<string>) => (object: Object) => Object) & ((methodNames: $ReadOnlyArray<string>, object: Object) => Object),
		cond(pairs: NestedArray<Function>): Function,
		constant<T>(value: T): () => T,
		always<T>(value: T): () => T,
		defaultTo: (<T1: void | null, T2>(defaultValue: T2) => (value: T1) => T2) &
			(<T1: void | null, T2>(defaultValue: T2, value: T1) => T2) &
			(<T1: string | boolean, T2>(defaultValue: T2) => (value: T1) => T1) &
			(<T1: string | boolean, T2>(defaultValue: T2, value: T1) => T1) &
			// NaN is a number instead of its own type, otherwise it would behave like null/void
			(<T1: number, T2>(defaultValue: T2) => (value: T1) => T1 | T2) &
			(<T1: number, T2>(defaultValue: T2, value: T1) => T1 | T2),
		flow: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		pipe: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		flowRight: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		compose: any & ((funcs: $ReadOnlyArray<Function>) => Function),
		identity<T>(value: T): T,
		iteratee(func: any): Function,
		matches: ((source: Object) => (object: Object) => boolean) & ((source: Object, object: Object) => boolean),
		matchesProperty: ((path: Path) => (srcValue: any) => Function) & ((path: Path, srcValue: any) => Function),
		propEq: ((path: Path) => (srcValue: any) => Function) & ((path: Path, srcValue: any) => Function),
		pathEq: ((path: Path) => (srcValue: any) => Function) & ((path: Path, srcValue: any) => Function),
		...
		mixin: (<T: Function | Object>(object: T) => ((source: Object) => (options: { chain: boolean, ... }) => T) & ((source: Object, options: { chain: boolean, ... }) => T)) &
			(<T: Function | Object>(object: T, source: Object) => (options: { chain: boolean, ... }) => T) &
			(<T: Function | Object>(object: T, source: Object, options: { chain: boolean, ... }) => T),
		noConflict(): Lodash,
		noop(...args: $ReadOnlyArray<mixed>): void,
		nthArg(n: number): Function,
		...
		property: ((path: Path) => (object: Object | $ReadOnlyArray<any>) => any) & ((path: Path, object: Object | $ReadOnlyArray<any>) => any),
		propertyOf: ((object: Object) => (path: Path) => Function) & ((object: Object, path: Path) => Function),
		range: ((start: number) => (end: number) => Array<number>) & ((start: number, end: number) => Array<number>),
		rangeStep: ((step: number) => ((start: number) => (end: number) => Array<number>) & ((start: number, end: number) => Array<number>)) &
			...
			((step: number, start: number, end: number) => Array<number>),
		rangeRight: ((start: number) => (end: number) => Array<number>) & ((start: number, end: number) => Array<number>),
		...
		stubTrue(): true,
		T(): true,
		times: (<T>(iteratee: (i: number) => T) => (n: number) => Array<T>) & (<T>(iteratee: (i: number) => T, n: number) => Array<T>),
		toPath(value: any): Array<string>,
		uniqueId(prefix: string): string,
		...
		convert(options: { cap?: boolean, curry?: boolean, fixed?: boolean, immutable?: boolean, rearg?: boolean, ... }): void,
