...
const navigates = [
	...
	{ id: 4, name: 'OrdersFilterOpenedPage', url: '/OrdersFilterOpenedPage' },
	{ id: 5, name: 'OrdersFilterClosedPage', url: '/OrdersFilterClosedPage' },
	{ id: 6, name: 'OrderListPreviewPage', url: '/OrderListPreviewPage' },
